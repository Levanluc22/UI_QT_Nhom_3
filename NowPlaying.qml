        ...
        Column {
            ...
            Row {
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            if (MusicApp.isShuffle) {
                                MusicApp.isRepeat = false
                            }
                        }
                    }
                }
                ...
                Rectangle {
                    ...
                    Image {
                        source: "qrc:/image_icons/backward.png"
                        width: 22
                        height: 22
                        fillMode: Image.PreserveAspectFit
                        anchors.centerIn: parent
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        gradient: Gradient {
                            GradientStop {
                                position: 0.0
                                color: mousePlay.containsMouse ? "#d8b4fe" : "#c084fc"
                            }
                            GradientStop {
                                position: 1.0
                                color: mousePlay.containsMouse ? "#f17eb8" : "#db2777"
                            }
                        }
                        Image {
                ...
                Rectangle {
                    ...
                    Image {
                        source: "qrc:/image_icons/forward.png"
                        width: 22
                        height: 22
                        fillMode: Image.PreserveAspectFit
                        anchors.centerIn: parent
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            if (MusicApp.isRepeat) {
                                MusicApp.isShuffle = false
                            }
                        }
                    }
                }
